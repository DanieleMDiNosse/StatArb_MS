...
def trading(df_returns, df_score, Q, beta_tensor, epsilon=0.0005, s_bo=1.25, s_so=1.25, s_bc=0.75, s_sc=0.50):
    ...
    # no_days_trading = np.zeros(shape=(df_score.shape[0], 3))
    ...
    for day in range(df_score.shape[0] - 1):
        ...
        # if counter_no_trades >= int(df_score.shape[1]*0.50):
        #     no_days_trading[day, 0] = 1
        # if counter_no_trades >= int(df_score.shape[1]*0.60):
        #     no_days_trading[day, 1] = 1
        # if counter_no_trades >= int(df_score.shape[1]*0.70):
        #     no_days_trading[day, 2] = 1
